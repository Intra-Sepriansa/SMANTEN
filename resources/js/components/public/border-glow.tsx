...
export const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '173 80 40', // Adjusted default to Teal
  backgroundColor = 'transparent', // The user cards have their own backgrounds
  borderRadius = 32, // Matches rounded-[2rem]
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#0F766E', '#F59E0B', '#0E9EE4'], // School theme colors
  fillOpacity = 0.5,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col relative z-[2] h-full">
        {children}
      </div>
    </div>
  );
